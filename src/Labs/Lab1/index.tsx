export default function Lab1() {
    ...
    <div id="wd-lab1">
        <h2>Lab 1</h2>
        <h3>Jay Sridharan, CS5610-01 SP25</h3>
        <h3>HTML Examples</h3>
        <div id="wd-h-tag">
            <h4>Heading Tags</h4>
        ...
        <div id="wd-lists">
            ...
            <h5>Ordered List Tag</h5>
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Boil 6 cups of water. Salt heavily and add 1 lb of your favorite pasta, cooking to box instructions</li>
                    <li>Melt butter in a sauce pan. Add three tablespoons flour and cook until browned with a nutty smell. Add milk and stir until it becomes paste like</li>
                    <li>Add 2.5 lbs of freshly shredded cheese. I use colby jack, mozzarella, and cheddar. Stir until cheese is melted and fully incorporated. Finally mix in pasta.</li>
                </ol>
        ...
        <div id="wd-forms">
            ...
            <form id="wd-text-fields">
                ...
                <a href="https://github.com/jsridha/kambaz-react-web-app" id="wd-github">Github.com</a>
                <br/>
            </form>
        </div>
